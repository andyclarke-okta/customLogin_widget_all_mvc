...
namespace OktaJS_SDK.Models
{
    ...
    public class CustomUserProfile : UserProfile
    {
        ...
        [JsonProperty("passwordInOkta")]
        public string passwordInOkta { get; set; }
        [JsonProperty("activation_passCode")]
        public string activation_passCode { get; set; }

        [JsonProperty("activation_setDate")]
        public string activation_setDate { get; set; }
    }
